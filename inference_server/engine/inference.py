...
from .model_loader import ModelFormat, ModelInfo, ModelLoader, get_model_loader
...
class InferenceResult:
    ...
    multi_label_predictions: list[dict[str, Any]] | None = None
    region_scores: dict[int, float] | None = None
