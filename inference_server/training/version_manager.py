...
class ModelVersionManager:
    ...
    def get_model_filename(self, version: ModelVersion | None = None) -> str:
        """Get model filename for a version."""
        v = version or self.current_version
        return f"student_model_{v}.pt"

    def get_model_path(self, version: ModelVersion | None = None) -> Path:
...
# Global instance
_version_manager: ModelVersionManager | None = None
