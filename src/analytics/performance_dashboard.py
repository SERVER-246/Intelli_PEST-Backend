...
class PerformanceDashboard:
    ...
    def generate_all_charts(self, output_dir: Optional[Union[str, Path]] = None) -> List[str]:
        """
    ...
    def generate_markdown_report(
        ...
        # Build report
        lines = [
            f"# Intelli-PEST Performance Report",
            f"",
        ...
        if include_charts:
            lines.extend([
                f"## Accuracy Trend",
                f"",
                f"![Accuracy Trend](charts/accuracy_trend_daily.png)",
                f"",
            ])
        ...
        lines.extend([
            ...
            f"",
            f"| Class | Predictions | Accuracy | Precision | Recall | F1 |",
            f"|-------|-------------|----------|-----------|--------|-----|",
        ])
        ...
        if include_charts:
            lines.extend([
                f"![Class Accuracy](charts/class_accuracy.png)",
                f"",
            ])
        ...
        if corrections:
            lines.extend([
                f"## Most Common Misclassifications",
                f"",
            ...
            if include_charts:
                lines.extend([
                    f"![Correction Frequency](charts/correction_frequency.png)",
                    f"",
                ])
        ...
        if 'top_improving' in trends and trends['top_improving']:
            lines.extend([
                f"## Class Improvement Trends",
                f"",
                f"### Top Improving Classes 📈",
                f"",
            ])
        ...
        if model_comparison:
            lines.extend([
                ...
                f"",
                f"| Version | Predictions | Accuracy | Avg Confidence | Active Days |",
                f"|---------|-------------|----------|----------------|-------------|",
            ])
            ...
            if include_charts:
                lines.extend([
                    f"![Model Comparison](charts/model_comparison.png)",
                    f"",
                ])
        ...
        if 'confidence_calibration' in overall:
            lines.extend([
                ...
                f"",
                f"| Confidence Bin | Avg Confidence | Actual Accuracy | Gap | Count |",
                f"|----------------|----------------|-----------------|-----|-------|",
            ])
        ...
        lines.extend([
            f"---",
            f"",
            f"*Report generated by Intelli-PEST Analytics System*",
        ])
    ...
    def export_overall_metrics_csv(self, output_path: Optional[Union[str, Path]] = None) -> str:
    ...
    def export_class_metrics_csv(self, output_path: Optional[Union[str, Path]] = None) -> str:
    ...
    def export_confusion_matrix_csv(self, output_path: Optional[Union[str, Path]] = None) -> str:
    ...
    def export_corrections_csv(self, output_path: Optional[Union[str, Path]] = None) -> str:
    ...
    def export_all_csv(self, output_dir: Optional[Union[str, Path]] = None) -> List[str]:
