...
def plot_training_history(history, save_path, title="Training History"):
    ...
    if head_epochs > 0:
        axes[0, 0].axvline(x=head_epochs-0.5, color='gray', linestyle='--', alpha=0.7, label='Head→Fine-tune')
    ...
    if head_epochs > 0:
        axes[0, 1].axvline(x=head_epochs-0.5, color='gray', linestyle='--', alpha=0.7, label='Head→Fine-tune')
    ...
    if head_epochs > 0:
        axes[1, 0].axvline(x=head_epochs-0.5, color='gray', linestyle='--', alpha=0.7, label='Head→Fine-tune')
